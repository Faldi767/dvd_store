    ...
    <div id="all">
              ...
              <div class="d-flex justify-content-md-end justify-content-between">
                <ul class="list-inline contact-info d-block d-md-none">
                  ...
                  <?php if($this->session->userdata('status') != "login") {
                    ?>
                    <a href="<?php echo base_url('view/register'); ?>" class="signup-btn"><i class="fa fa-user"></i><span class="d-none d-md-inline-block">Sign Up</span></a>
                  ...
                  <?php if($this->session->userdata('status') == "login") { ?>
                    <a href="<?php echo base_url('view/history'); ?>" class="signup-btn"><i class="fa fa-shopping-cart"></i><span class="d-none d-md-inline-block">Transaction History</span></a>
                  <a href="<?php echo base_url('view/logout'); ?>" class="signup-btn"><i class="fa fa-user"></i><span class="d-none d-md-inline-block">Logout</span></a>
                  <?php
                } ?>
                </div>
              </div>
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="<?php echo base_url(); ?>" class="navbar-brand home">Video Store<span class="sr-only">Universal - go to homepage</span></a>
