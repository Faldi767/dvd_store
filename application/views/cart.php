                ...
                <form method="get" action="shop-checkout1.html">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo base_url('view/deletecart/'); ?><?php echo $c->id_cart; ?>"><i class="fa fa-trash-alt"></i></a></td>
                        </tr>
                      <?php } ?>
                      </tbody>
                      <tfoot>
                        <tr>
                          ...
                          <th colspan="2"><?php foreach($total as $t) { echo $t->total;$totalharga = $t->total; } ?></th>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
                  <div class="box-footer d-flex justify-content-between align-items-center">
                    ...
                    <div class="right-col">
                      ...
                      <?php 
                      if($totalharga != 0) {
                      echo base_url('view/checkout'); 
                      } else {
                        echo base_url('view/shop');
                      }
                      ?>
                      " type="button" class="btn btn-template-outlined">Proceed to checkout <i class="fa fa-chevron-right"></i></a>
                    </div>
                  </div>
                </form>
              </div>
