...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2020 at 11:36 AM
...
INSERT INTO `tbl_order` (`id_order`, `id_customer`, `amount`, `order_date`, `order_status`) VALUES
(4, 2, 80000, '2018-05-30', 'Complete'),
(5, 2, 74000, '2018-05-30', 'Complete'),
(6, 2, 90000, '2018-05-30', 'Complete'),
(10, 4, 150000, '2018-07-12', 'Complete'),
(17, 4, 40000, '2020-01-22', 'Completed'),
(18, 4, 50000, '2020-01-22', 'Completed');
...
--
ALTER TABLE `tbl_cart`
  MODIFY `id_cart` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
